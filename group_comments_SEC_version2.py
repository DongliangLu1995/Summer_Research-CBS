# -*- coding: utf-8 -*-
"""
Created on Wed Jun 20 11:22:26 2018
...
#to deal with org
#1. to see whether it's an abbreviation, and if it has more than 2 upper words or has a bracket, get them 
#2. stemlize(lower, stem and remove stop) both the org in meeting and org in comments
#3. use partial ratio and ratio of the stemlized orgs and compare them, choose the org with highest original ratio
