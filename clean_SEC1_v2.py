...
for key in SEC_org.keys():
    s+=SEC_org[key]
print("s "+str(s))
meeting_df_total.loc[748,"organization"]
meeting_df_total.loc[347,"organization"]
